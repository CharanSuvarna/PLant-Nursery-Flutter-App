...
import 'package:green_saplings/ui/signin_page.dart';
...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  //Create the indicator decoration widgets
//The Widget is to be created inside our Onboarding Screen class to access the currentIndex variable
...
class createPage extends StatelessWidget {
  //Declaring final parameter for the widget
  final String image;
  final String title;
  final String description;
  //Add final variable to the constructor
  const createPage({
    super.key, required this.image, required this.title, required this.description,
  });
//iilige stopp agidhe 12.54
  @override
  Widget build(BuildContext context) {
    return Container(
