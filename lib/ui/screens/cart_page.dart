...
import 'package:green_saplings/ui/screens/widgets/plant_widget.dart';
                  ...
                  Expanded(
                    child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          print("Displaying plant: ${widget.addedToCartPlants[index].plantName}");
                          return PlantWidget(
