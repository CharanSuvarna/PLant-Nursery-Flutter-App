...
class _DetailPageState extends State<DetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    //Import Palnt Model Data
    List<Plant> _plantList = Plant.plantList;
    //Add the passed parameter of the Detailed page route
                    ...
                    Positioned(
                      ...
                      child: SizedBox(
                        ...
                        child: Column(
                          ...
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            //Extractring widget foe reuasablity
                            PlantFeature(
                              title: 'Size',
...
class PlantFeature extends StatelessWidget {
  //adding requires parameter for the widgets
